 ...
 * @see com.test_build2_24th.t12.Table2
 */
@Service("t12.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "t12TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "t12TransactionManager")
    @Override
