...
import com.test_build2_24th.t12.service.Table1Service;
import com.test_build2_24th.t12.service.Table2Service;
import java.io.*;
...
import com.test_build2_24th.t12.service.*;
import com.wavemaker.tools.api.core.annotations.WMAccessVisibility;
import com.wavemaker.tools.api.core.models.AccessSpecifier;

/**
 * Controller object for domain model class Table1.
 * @see com.test_build2_24th.t12.Table1
 */
@RestController(value = "T12.Table1Controller")
@RequestMapping("/t12/Table1")
...
public class Table1Controller {
    ...
    @Autowired
    @Qualifier("t12.Table1Service")
    private Table1Service table1Service;

    @Autowired
    @Qualifier("t12.Table2Service")
    ...
    public Page<Table2> findAssociatedtable2sForColumn2(Pageable pageable, @PathVariable("id") Integer id) {
        LOGGER.debug("Fetching all associated table2sForColumn2");
        return table2Service.findAssociatedValues(id, "table1ByColumn2", "id", pageable);
    }
