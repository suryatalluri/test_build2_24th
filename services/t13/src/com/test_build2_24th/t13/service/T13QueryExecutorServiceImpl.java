...
@Service
public class T13QueryExecutorServiceImpl implements T13QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(T13QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("t13WMQueryExecutor")
