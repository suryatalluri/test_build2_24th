...
public class Table1ServiceImpl implements Table1Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "t13TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "t13TransactionManager")
    @Override
